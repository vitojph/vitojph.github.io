...
- Actualmente, vivimos un auge de los sistemas de aprendizaje automático, con especial énfasis en el uso de la Web. 

- Y en los últimos años hemos visto el resurgir de los sistemas que utilizan **redes neuronales** para modelar conocimiento a partir de ingentes cantidades de datos no anotados (*deep learning*).
...
- librerías para tareas de PLN: [NLTK](http://www.nltk.org/), [GATE](https://gate.ac.uk/), [Tensorflow](https://www.tensorflow.org), [IBM Watson](https://developer.ibm.com/watson/), [FreeLing](http://nlp.cs.upc.edu/freeling/), [pattern](http://www.clips.ua.ac.be/pattern)... [awesome-nlp](https://github.com/keon/awesome-nlp).
